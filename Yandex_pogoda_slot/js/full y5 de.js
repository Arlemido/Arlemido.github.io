...
(function ()
{
    ...
    function i(H, F)
    {
        ...
        E = r & G;
        if (H.ctrl) {
            E^=C // внимание, декомпилятор выдает с пробелами, не рабочий вариант E^ = C
        }
        if (H.alt) {
            E^=n // внимание, декомпилятор выдает с пробелами, не рабочий вариант E^ = n
        }
        if (H.shift) {
            E^=s // внимание, декомпилятор выдает с пробелами, не рабочий вариант E^ = s
        }
        return E
    }
    function a(E, F)
